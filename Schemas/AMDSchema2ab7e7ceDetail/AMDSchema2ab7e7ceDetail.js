define("AMDSchema2ab7e7ceDetail", ["ProcessModuleUtilities","ConfigurationGrid", "ConfigurationGridGenerator",
	...
	return {
			...
			createL2: function(){
					...
					if (primaryId) {
						ProcessModuleUtilities.executeProcess({
							sysProcessName: "AMDProcess_CreateRecords",
							parameters: {
								RecordId: primaryId
							}
						});
		...
		diff: /**SCHEMA_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "AMDCreateL2RecordButton",
				"values": {
					"itemType": 5,
					"style": this.Terrasoft.controls.ButtonEnums.style.GREEN,
					"caption": {
						"bindTo": "Resources.Strings.CreateL2RecordCaption"
					},
					"enabled": {"bindTo": "AMDButtonEnabled"},
					"click": {"bindTo": "createL2"}
